...
const appRedeemKpt = async (app_id, amount, cash_transaction_id, owner_pub_key, owner_sign, sender_pub_key, sender_sign) => {
  app_id = Number(app_id);
  ...
  params = [app_id, convertBalance(amount), cash_transaction_id, owner_pub_key, owner_sign, sender_pub_key, sender_sign];
  const result = await sendTx(txInfo, params);
