...
const { stringToU8a, u8aToHex, hexToU8a, hexToString, u8aToString, u8aConcat, formatBalance, BN_ONE, BN_ZERO } = require('@polkadot/util');
...
const { AppFinancedProposalParams, AppFinancedUserExchangeParams, AppFinancedUserExchangeConfirmParams, CommentData,
  ...
  ClientParamsCreateModelDoc, ModelExpertAddMemberParams, ModelExpertDelMemberParams, ModelIncomeCollectingParam } = require('./signParamsDefine');
