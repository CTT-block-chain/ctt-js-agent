...
const createDocument = async (sender_pub_key, password, document, server_pub_key, server_sign) => {
  isKeyringReady();
  isApiReady();
  ...
  return new Promise(async (resolve, reject) => {
    ...
    createApi(
      ...
      server_pub_key, //TODO: app_pub_key
      server_sign,
...
const createModel = async (sender_pub_key, password, model, server_pub_key, server_sign) => {
  return new Promise(async (resolve, reject) => {
    const keyPair = this.keyring.getPair(sender_pub_key);
    keyPair.decodePkcs8(password);
...
const disableModel = async (sender_pub_key, password, model, server_pub_key, server_sign) => {
  return new Promise(async (resolve, reject) => {
    const keyPair = this.keyring.getPair(sender_pub_key);
    keyPair.decodePkcs8(password);
