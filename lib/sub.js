...
const createKnowledge = async (sender_pub_key, password, knowledge, server_pub_key, server_sign) => {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    // TODO: this is just dev test
    // test auth server
    //const testAuthServer = this.keyring.addFromUri("//Alice", { name: "Alice default" });
    //const testSign = testAuthServer.sign(hexToU8a(sub.hash("hello")));
    ...
    this.api.tx.kp
      //.test(hash("abc"), 1, "abc", "5FHittguiXZgbt5qu1frKASSedmxy6QLYDHSRVsf6B7Dj9qk")
      .createKnowledge(
        app_id,
        knowledge_type,
        knowledge_id,
