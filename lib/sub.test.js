...
test('should model cycle income success', () => {
  const processTest = () => {
    const testJson = JSON.parse(
      `{"address":"5FHittguiXZgbt5qu1frKASSedmxy6QLYDHSRVsf6B7Dj9qk","encoded":"","encoding":{"content":["pkcs8","sr25519"],"type":"xsalsa20-poly1305","version":"2"},"meta":{"name":"bob"}}`
    );
    ...
    let incomes = [
      {
        model_id: "M01-" + new Date().getTime(),
        income: '123.4'
      },
      {
        model_id: "M02-" + new Date().getTime(),
        income: '1233.4'
      }
    ];

    // give some fees
    const prepareFees = () => sub.devTransfer(testJson.address, '100');
