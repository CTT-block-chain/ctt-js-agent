...
test('verify sign should success', () => {
  return sub.initKeyring().then(() => {
    ...
    sub.setupAccountByJson(testJson);
    sub.unlock(testJson.address, '123456');
    const sign = sub.sign(testJson.address, '77a911aff1ce03673bb876820fa73098b5bb654a4846aef7edf82bfaf7d6c0a6148360');
    console.log('sign:', sign, testJson.address);
    const verify = sub.verify(
      testJson.address,
      '77a911aff1ce03673bb876820fa73098b5bb654a4846aef7edf82bfaf7d6c0a6148360',
      sign
    );
