...
test('should create product identify document success', () => {
  const processTest = () => {
    ...
    let params = InterfaceClientParamsCreateIdentifyDoc.create(APP_ID, DOC_IDENTIFY_ID, PRODUCT_ID, sub.hash('hello'), '100', '23', '78', '50', 'C0001' + new Date().getTime());
...
test('should power compute correct', () => {
  const processTest = () => {
    ...
    const createPubDoc = () => {
      let params = InterfaceClientParamsCreatePublishDoc.create(app_id, pub_doc_id, model_id, product_id, sub.hash('hello'), '95', '0', '10');
    ...
    const createIdentifyDoc = () => {
      let params = InterfaceClientParamsCreateIdentifyDoc.create(app_id, identify_doc_id, product_id, sub.hash('hello'), goods_price, '0', '0', '10', cart_id);
    ...
    const createTryDoc = () => {
      let params = InterfaceClientParamsCreateTryDoc.create(app_id, try_doc_id, product_id, sub.hash('hello'), goods_price, '0', '0', '10', cart_id);
